...
julia --project=$(project_dir) -e 'using Pkg; Pkg.instantiate(); Pkg.add(["CairoMakie", "PairPlots", "Distributions", "Unitful"])' 2>&1 | tee $(log_dir)/instantiate_\${SLURM_JOB_ID}.log
