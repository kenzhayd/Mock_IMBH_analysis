...
julia --project=/lustre09/project/6039459/vhenault/OCen_IMBH/Ocen_IMBH_analysis/configs/../../Octofitter_imbh.jl -e 'using Pkg; Pkg.instantiate()' 2>&1 | tee /lustre09/project/6039459/vhenault/OCen_IMBH/Ocen_IMBH_analysis/configs/../results/logs/instantiate_${SLURM_JOB_ID}.log
