...
- **Date:** 2026-04-11T17:37:10.057
- **Slurm Job ID:** 10184975
- **Stars:** A, C, D, E, F
- **Reference epoch:** 55197.0 MJD (2010.0 yr)
- **Config file:** /lustre09/project/6039459/vhenault/OCen_IMBH/Ocen_IMBH_analysis/configs/ACDEF_Daccel_only.toml
...
description = "5-star fit: A, C, D, E, F, no acceleration except D (2.4σ detection)"
...
[data.z_prior]
sigma_z_au = 4558           # 1σ = 0.0221 pc [AU]

# Per-star overrides: enable acceleration for D only (strongest detection, ~2.4σ total)
[data.overrides.D]
acceleration = true
