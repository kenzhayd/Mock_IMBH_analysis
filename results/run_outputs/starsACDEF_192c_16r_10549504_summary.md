...
- **Date:** 2026-04-17T15:45:06.658
- **Slurm Job ID:** 10549504
- **Stars:** A, C, D, E, F
- **Reference epoch:** 55197.0 MJD (2010.0 yr)
- **Config file:** /lustre09/project/6039459/vhenault/OCen_IMBH/Ocen_IMBH_analysis/configs/noAccel_16r.toml
- **Run type:** fresh
...
[data.z_prior]
sigma_z_au = 20000           # 1σ = 0.0221 pc [AU]
...
| | Path |
|---|---|
| PT exec folder | `unknown` |
| PT location file | `/lustre09/project/6039459/vhenault/OCen_IMBH/Ocen_IMBH_analysis/configs/../results/run_outputs/starsACDEF_192c_16r_10549504_pt_location.txt` |
